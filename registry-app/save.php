...
// مثال SQL لإنشاء جدول متوافق مع هذا المشروع كامل (فورم + جدول + تبديل حالة):
//
...
// );
//
// لو عمود status عندك موجود بالفعل بجدول مختلف، تأكد بس إنه من نوع
// رقمي يقبل 0 أو 1، وحدّث اسمه في db.php ($COLUMN_STATUS) لو مختلف.
